...
const testimonials = [
  {
    name: "מיטל, אמא של עמית (מתמטיקה, כיתה ט')",
    text: "היי רועי!! כולי התרגשות – עמית קיבלה 100 במבחן!!! עכשיו התקשרה לספר לי. תודה ענקית 🙏 אתה אלוף!",
  },
  {
    name: "ליאת, אמא של תהל (מתמטיקה, 5 יח\"ל)",
    text: "היי רועי, מה שלומך? רציתי לעדכן שתהל קיבלה בבגרות 98 😁 נהיה בקשר גם בשנה הקרובה, לא רק לפני המבחנים.",
  },
  {
    name: "איתי, תלמיד כיתה י\"א (מדעי המחשב)",
    text: "בוקר טוב רועי, תודה שעזרת לי למבחן במדעי המחשב 🙏 קיבלתי 94 – הציון הכי גבוה שלי עד עכשיו! (היה לי 57...)",
  },
  {
    name: "נועה, אמא של זיו (מתמטיקה, 5 יח\"ל)",
    text: "זיו קיבל את המבחן שלו בחזרה – 92!!! 🥳 הוא יראה לך היום בשיעור. שוב תודה ענקית 🙏 כבר רואים את השיפור.",
  },
  {
    name: "ארבל (השלמת בגרות בפיזיקה)",
    text: "תמיד אומרים שהחלק הקשה בפיזיקה זה הבגרות, אבל איתך זה היה פשוט קל. בזכות המסירות שלך והיכולת להסביר מאפס אני עם 96 במכניקה ו-93 בחשמל! תודה ענקית 🙏",
  },
  {
    name: "דניאל, תלמיד כיתה י\"ב (מתמטיקה, 5 יח\"ל)",
    text: "רועי, תודה על הכול! כשהתחלנו ללמוד, לא האמנתי שאצליח ב-5 יחידות. בזכות ההסברים והגישה שלך, הציונים שלי השתפרו משמעותית ואני סוף סוף מרגיש ביטחון בחומר.",
  }
]
