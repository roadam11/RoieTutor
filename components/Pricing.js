          ...
          <div className="rounded-2xl p-6 bg-white/70 dark:bg-white/5 backdrop-blur ring-1 ring-tealBrand/40">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs bg-emerald-500/15 text-emerald-700 dark:text-emerald-300 px-2 py-1 rounded-full">
                  כולל ליווי בין שיעורים
                </span>
              </div>
            ...
            <a
              href="#quick"
              className="mt-5 inline-flex justify-center w-full rounded-xl bg-gradient-to-b from-tealBrand to-tealBrand/90 text-[#061019] font-semibold px-4 py-3 hover:shadow-md"
            >
              תיאום מהיר
            </a>
          </div>
