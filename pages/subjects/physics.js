...
export default function PhysicsPage() {
  ...
  return (
    <SubjectLayout
      ...
      icon={<PhysicsIcon className="w-6 h-6" />}
      gradient="from-amber-200/40 to-orange-100/0 dark:from-amber-500/10 dark:to-transparent"
      accent="#f59e0b"
    >
      <Head><title>RoieTutor — פיזיקה</title><meta name="description" content="שיעורים פרטיים בפיזיקה: חטיבה, 5 יח״ל וסטודנטים. הסברים בהירים, תרגול ממוקד וליווי בין שיעורים." /></Head>

      <ValueStrip />

      <Section title="חטיבה" text="כוח ותנועה, אנרגיה וחוקי שימור — עם המחשות ודוגמאות חכמות." ctaHref={wa('חטיבה')} />
      <Section title="תיכון (5 יח״ל)" text="מכניקה, חשמל ומגנטיות, קרינה וחומר. אימון לניהול זמן ופתרון סוגי שאלות מרכזיים." bullets={['סיכומי שיעור ברורים','ליווי בין שיעורים לשאלות קצרות','תרגול ממוקד לפי נקודות חולשה']} ctaHref={wa('תיכון 5 יח״ל')} />
      <Section title="סטודנטים" text="מכניקה ניוטונית, אלקטרומגנטיות ומבנה חומר — התאמה לסילבוס ולמרצה." ctaHref={wa('סטודנטים')} />
    </SubjectLayout>
  )
}
