          ...
          <div className="grid md:grid-cols-2 gap-10">
            <div className="rounded-2xl border border-black/10 dark:border-white/10 bg-white/60 dark:bg-white/5 backdrop-blur p-5">
              ...
              <div className="mt-3 grid gap-3">
                <a className="flex items-center gap-2 rounded-xl border border-black/10 dark:border-white/10 bg-white/70 dark:bg-white/5 px-3 py-2" href="https://wa.me/972549480190">וואטסאפ: <span dir="ltr" className="font-semibold">054-948-0190</span></a>
                <a className="flex items-center gap-2 rounded-xl border border-black/10 dark:border-white/10 bg-white/70 dark:bg-white/5 px-3 py-2" href="mailto:Roadam11@gmail.com">מייל: <span className="font-semibold">Roadam11@gmail.com</span></a>
                <a className="flex items-center gap-2 rounded-xl border border-black/10 dark:border-white/10 bg-white/70 dark:bg-white/5 px-3 py-2" href="tel:+972549480190">טלפון: <span dir="ltr" className="font-semibold">054-948-0190</span></a>
              </div>
            </div>
            <form className="rounded-2xl border border-black/10 dark:border-white/10 bg-white/60 dark:bg-white/5 backdrop-blur p-5" onSubmit={(e)=>{e.preventDefault(); alert('תודה! נחזור אליך בהקדם.');}}>
              <label className="block">שם מלא<br/><input className="w-full mt-1 rounded-xl border border-black/10 dark:border-white/10 bg-white dark:bg-white/5 px-4 py-3" placeholder="לדוגמה: דנה לוי" /></label>
